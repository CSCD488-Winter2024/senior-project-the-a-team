...
class _EditProfile extends State<EditProfile> {
  ...
  Future<void> updateAccount(TextEditingController usernameController,
  ...
  Future<void> setPfp(String img) {
    return user.doc(currentUser!.uid).update({'pfp': img});
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          leading: IconButton(
            onPressed: () async {
              bool changes = usernameController.text.isNotEmpty ||
              ...
              children: [
                PopScope(
                  ...
                  onPopInvoked: (bool didPop) async {
                    ...
                    final bool changes = usernameController.text.isNotEmpty ||
                        nameController.text.isNotEmpty ||
                        passwordController.text.isNotEmpty ||
                        confirmPasswordController.text.isNotEmpty ||
                        selectedImage != null;
                      ...
                      await showDialog(
                          ...
                          builder: (context) {
                            return AlertDialog(
                                ...
                                content: const Text(
                                  "You're about to make changes to your account.",
                                ),
                                actions: [
                                  TextButton(
                                    onPressed: () =>
