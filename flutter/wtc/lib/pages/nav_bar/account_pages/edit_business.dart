...
import 'package:wtc/widgets/components/hour_input.dart';
...
class _EditBusinessInfoState extends State<EditBusinessInfo> {
  ...
  final TextEditingController _wednesdayOpenController =
      TextEditingController();
  final TextEditingController _wednesdayCloseController =
      TextEditingController();
  final TextEditingController _thursdayOpenController = TextEditingController();
  final TextEditingController _thursdayCloseController =
      TextEditingController();
  ...
  final TextEditingController _saturdayCloseController =
      TextEditingController();
  ...
  Future<void> submitApplication(String newAddress, String name) async {
    await FirebaseFirestore.instance
      ...
      "businessHours": {
        "Monday":
            "${_mondayOpenController.text.trim()} - ${_mondayCloseController.text.trim()}",
        "Tuesday":
            "${_tuesdayOpenController.text.trim()} - ${_tuesdayCloseController.text.trim()}",
        "Wednesday":
            "${_wednesdayOpenController.text.trim()} - ${_wednesdayCloseController.text.trim()}",
        "Thursday":
            "${_thursdayOpenController.text.trim()} - ${_thursdayCloseController.text.trim()}",
        "Friday":
            "${_fridayOpenController.text.trim()} - ${_fridayCloseController.text.trim()}",
        "Saturday":
            "${_saturdayOpenController.text.trim()} - ${_saturdayCloseController.text.trim()}",
        "Sunday":
            "${_sundayOpenController.text.trim()} - ${_sundayCloseController.text.trim()}",
      },
      ...
      body: FutureBuilder<DocumentSnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            PhoneNumber number =
                PhoneNumber(isoCode: "US", phoneNumber: data["phone"]);
            ...
            return Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  HourInput(
                      day: "Monday",
                      openHour: _mondayOpenController,
                      closeHour: _mondayCloseController),
                  ...
                  HourInput(
                      day: "Tuesday",
                      openHour: _tuesdayOpenController,
                      closeHour: _tuesdayCloseController),
                  ...
                  HourInput(
                      day: "Wednesday",
                      openHour: _wednesdayOpenController,
                      closeHour: _wednesdayCloseController),
                  ...
                  HourInput(
                      day: "Thursday",
                      openHour: _thursdayOpenController,
                      closeHour: _thursdayCloseController),
                  ...
                  HourInput(
                      day: "Friday",
                      openHour: _fridayOpenController,
                      closeHour: _fridayCloseController),
                  ...
                  HourInput(
                      day: "Saturday",
                      openHour: _saturdayOpenController,
                      closeHour: _saturdayCloseController),
                  ...
                  HourInput(
                      day: "Sunday",
                      openHour: _sundayOpenController,
                      closeHour: _sundayCloseController),
                  ...
                  ElevatedButton(
                    ...
                    onPressed: () async {
                      if (_addressController.text.isEmpty ||
                        ...
                        await showDialog(
                            ...
                            builder: (context) => AlertDialog(
                                  ...
                                  content: const Text(
                                      "Changing your address will require admin approval. Are you sure you want to change your address?"),
                                  actions: [
                                    TextButton(
                                      onPressed: () {
                      ...
                      } else if (_bioController.text != data["about"] ||
                          _phoneController.text != data["phone"] ||
                          _mondayOpenController.text !=
                              monday.split(" - ")[0] ||
                          _mondayCloseController.text !=
                              monday.split(" - ")[1] ||
                          _tuesdayOpenController.text !=
                              tuesday.split(" - ")[0] ||
                          _tuesdayCloseController.text !=
                              tuesday.split(" - ")[1] ||
                          _wednesdayOpenController.text !=
                              wednesday.split(" - ")[0] ||
                          _wednesdayCloseController.text !=
                              wednesday.split(" - ")[1] ||
                          _thursdayOpenController.text !=
                              thursday.split(" - ")[0] ||
                          _thursdayCloseController.text !=
                              thursday.split(" - ")[1] ||
                          _fridayOpenController.text !=
                              friday.split(" - ")[0] ||
                          _fridayCloseController.text !=
                              friday.split(" - ")[1] ||
                          _saturdayOpenController.text !=
                              saturday.split(" - ")[0] ||
                          _saturdayCloseController.text !=
                              saturday.split(" - ")[1] ||
                          _sundayOpenController.text !=
                              sunday.split(" - ")[0] ||
                          _sundayCloseController.text !=
                              sunday.split(" - ")[1]) {
                        bool confirm = false;
                        await showDialog(
                            context: context,
