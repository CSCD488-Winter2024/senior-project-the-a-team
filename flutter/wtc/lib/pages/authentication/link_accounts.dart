                                    ...
                                    try {
                                      ...
                                      showDialog(
                                        ...
                                        builder: (context) {
                                          return AlertDialog(
                                            ...
                                            content: const Text(
                                                "A verification email has been sent to your email. You may have to check your spam folder."),
                                            actions: [
                                              TextButton(
                                                onPressed: () {
                                                  Navigator.pop(context);
                                      ...
                                      if (e.code == 'provider-already-linked') {
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(const SnackBar(
                                          content: Text(
                                              "An error occurred. Make sure you entered the correct email and password."),
                                        ));
                                        Navigator.pop(context);
                                      }
                                    }
