...
class _RSVPButtons extends State<RSVPButtons> {
  ...
  Future<void> changeIsAttending() async {
    ...
    try {
        await _firestore.collection('_posts').doc(widget.postID.toString()).update(
          {
            'attending': {
              widget.uid
            },
        ...
        await _firestore.collection('_posts').doc(widget.postID.toString()).update(
          {
            ...
            'attending.${widget.uid}': FieldValue.delete()
          }
      );
    }catch (e) {
      print('Error updating maybe status:$e');
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<DocumentSnapshot>(future: _firestore.collection('_posts').doc(widget.postID.toString()).get(), 
